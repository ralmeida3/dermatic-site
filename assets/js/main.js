...
const I18N = {
  pt: {
    ...
    "problem.title":"O problema quase nunca é o produto. É a ordem.",
    "problem.lead":"A maior parte das pessoas compra o ativo certo na hora errada, na concentração errada, junto de outro que anula o primeiro — e conclui que a própria pele “não responde”.",
    "problem.c1t":"Você compra pelo vídeo",
    "problem.c1d":"O produto que transformou a pele de outra pessoa pode ser exatamente o que quebra a sua barreira. Tipo de pele e sensibilidade mudam a resposta ao mesmo ativo.",
    "problem.c2t":"Você usa tudo junto",
    "problem.c2d":"Ácido e retinóide na mesma noite é a receita mais comum de ardência, descamação e desistência na terceira semana.",
    "problem.c3t":"Você pula o protetor",
    "problem.c3d":"Sem fotoproteção diária, clareador e antissinais viram dinheiro jogado fora: o sol desfaz numa manhã o que o produto levou semanas para construir.",
  ...
  en: {
    ...
    "problem.title":"The problem is rarely the product. It's the order.",
    "problem.lead":"Most people buy the right active at the wrong time, in the wrong concentration, next to another one that cancels it out — and conclude that their skin “doesn't respond”.",
    "problem.c1t":"You buy from a video",
    "problem.c1d":"The product that transformed someone else's skin can be exactly what breaks your barrier. Skin type and sensitivity change how the same active behaves.",
    "problem.c2t":"You use everything at once",
    "problem.c2d":"Acid and retinoid on the same night is the most common recipe for stinging, peeling and giving up in week three.",
    "problem.c3t":"You skip sunscreen",
    "problem.c3d":"Without daily sun protection, brighteners and anti-ageing actives are wasted money: the sun undoes in one morning what a product took weeks to build.",
